<main>
        <section class="section">
            <div class="container">
                <h1 class="page-title">Mon Kit Média</h1>
        ...
        <section class="section media-kit-section">
            <div class="container grid-container reversed">
        ...
        <section class="section collaborations-section">
            <div class="container">
